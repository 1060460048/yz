...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
    ...
    <div class="row sticky">
        <?php echo $form->labelEx($model,'t9nCategory'); ?>
        <?php echo $form->textField($model,'t9nCategory',array('size'=>65)); ?>
        <div class="tooltip">
            This is base translation category for model.
        </div>
        <?php echo $form->error($model,'t9nCategory'); ?>
    </div>
	<div class="row">
    ...
    <div class="row">
        <?php echo $form->labelEx($model,'createBehaviors'); ?>
        <?php echo $form->checkBox($model,'createBehaviors'); ?>
        <div class="tooltip">
            Whether behaviors should be generated for the model class.
            Currently supported behaviors are:
            <ul>
                <li>CTimestampBehavior for date_created and date_updated fields</li>
            </ul>
        </div>
        <?php echo $form->error($model,'createBehaviors'); ?>
    </div>
