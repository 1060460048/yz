...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
    ...
    <div class="row">
        <?php echo $form->labelEx($model,'addSearch'); ?>
        <?php echo $form->checkBox($model,'addSearch'); ?>
        <div class="tooltip">
            Whether search option should be generated for list of models.
        </div>
        <?php echo $form->error($model,'addSearch'); ?>
    </div>
