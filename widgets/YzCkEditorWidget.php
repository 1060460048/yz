...
/**
 * TODO Change class code to something more intellegent
 */

Yii::import('yz.widgets.YzInputWidget');

class YzCkEditorWidget extends YzInputWidget {
    const COLS = 40;
    const ROWS = 10;
...
//advanced - пользователь сам определяет тулбар
    ...
    public function run(){
        ...
        $assets = Yii::app()->getAssetManager()->publish($baseDir.DIRECTORY_SEPARATOR.'CkEditorAssets',false,-1,Yz::get()->alwaysUpdateAssets);
